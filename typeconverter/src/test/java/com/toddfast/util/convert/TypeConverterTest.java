...
public class TypeConverterTest {
	...
	@Test
	public void testConversionUnregistration() {
		...
		// Throw exception
		assertThrows(Exception.class,()->TypeConverter.convert(Bogus.class,"don't care"));
	}
	...
	public void testBogusInteger() {
		assertThrows(Exception.class,()->TypeConverter.asInt("bogus"));
	}
