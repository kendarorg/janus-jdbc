...
public class TestPreparedStatement extends TestDb {
    ...
    public void test() throws Exception {
        ...
        //FIXME testJson(conn);
        testArray(conn);
        //FIXME testSetObject(conn);
        //FIXME testSetObject2(conn);
    ...
    private void testUnsupportedOperations(Connection conn) throws Exception {
        ...
        assertThrows(Exception.class,()-> prep.
            addBatch("select 1"));
        ...
        //FXIME
        assertThrows(Exception.class,()->  prep.getParameterMetaData());
//        var meta = prep.getParameterMetaData();
...
//    }
    ...
    private void testExecuteErrorTwice(Connection conn) throws SQLException {
        ...
        assertThrows(Exception.class,()->  prep.execute());
        assertThrows(Exception.class,()->  prep.execute());
    }
    ...
    private void testUnknownDataType(Connection conn) throws SQLException {
        assertThrows(Exception.class,()->  conn.
...
//            } else {
            assertThrows(Exception.class,()-> prep.executeQuery());
            //}
        }
    ...
    @Test void testBigDecimal() throws SQLException {
        Connection conn = getConnection("preparedStatement");
        PreparedStatement prep = conn.prepareStatement("SELECT ?, ?");
    ...
    private void testInterval8(Connection conn) throws SQLException {
        ...
        assertThrows(Exception.class,()->  prep.setObject(1, period));
    ...
    private void testParameterMetaData(Connection conn) throws SQLException {
        ...
        assertThrows(Exception.class,()->  pm.getPrecision(0));
        assertThrows(Exception.class,()->  pm.getPrecision(4));
        prep.close();
        assertThrows(Exception.class,()->  pm.getPrecision(1));
    ...
    private void testLikeIndex(Connection conn) throws SQLException {
        ...
        //FIXME assertEquals(1, prep.getParameterMetaData().getParameterCount());
    ...
    private void testCasewhen(Connection conn) throws SQLException {
        ...
        //FIXME assertEquals(2, prep.getParameterMetaData().getParameterCount());
        prep.setString(1, "a");
        prep.setString(2, "a");
        rs = prep.executeQuery();
        rs.next();
    ...
    private void testSubquery(Connection conn) throws SQLException {
        ...
        //FIXME assertEquals(4, prep.getParameterMetaData().getParameterCount());
        prep.setInt(1, 0);
        prep.setInt(2, 1);
        prep.setInt(3, 2);
        prep.setInt(4, 4);
    ...
    private void testGetMoreResults(Connection conn) throws SQLException {
        ...
        //FIXME?? assertThrows(Exception.class,()->  rs.next());
        assertEquals(-1, prep.getUpdateCount());
...
//        assertEquals(ascii2, rs.getString(3));
    ...
    private void testPreparedStatementWithAnyParameter() throws SQLException {
        ...
        final PreparedStatement pps = ps;
        assertThrows(Exception.class,()->  pps.executeQuery());
        anyParameterCheck(ps, values, expected);
...
//FIXME        assertEquals(Types.INTEGER,
...
//                ps.getParameterMetaData().getParameterType(1));
    ...
    private void testMultipleStatements(Connection conn) throws SQLException {
        assertThrows(Exception.class,()->  conn.prepareStatement("SELECT ?; SELECT ?1"));
        assertThrows(Exception.class,()->  conn.prepareStatement("SELECT ?1; SELECT ?"));
        Statement stmt = conn.createStatement();
