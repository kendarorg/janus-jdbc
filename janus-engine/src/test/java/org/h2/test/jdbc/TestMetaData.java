...
public class TestMetaData extends TestDb {
    ...
    private void testUnsupportedOperations() throws SQLException {
        ...
        ResultSet rs = stat.executeQuery("select 1 as x from dual");
        ResultSetMetaData meta = rs.getMetaData();
        assertThrows(Exception.class,()-> meta.getColumnLabel(0));
        assertThrows(Exception.class,()-> meta.getColumnName(0));
        assertThrows(Exception.class,()-> meta.getColumnType(0));
        assertThrows(Exception.class,()-> meta.getColumnTypeName(0));
        assertThrows(Exception.class,()-> meta.getSchemaName(0));
        assertThrows(Exception.class,()-> meta.getTableName(0));
        assertThrows(Exception.class,()-> meta.getCatalogName(0));
        assertThrows(Exception.class,()-> meta.isAutoIncrement(0));
        assertThrows(Exception.class,()-> meta.isCaseSensitive(0));
        assertThrows(Exception.class,()-> meta.isSearchable(0));
        assertThrows(Exception.class,()-> meta.isCurrency(0));
        assertThrows(Exception.class,()-> meta.isNullable(0));
        assertThrows(Exception.class,()-> meta.isSigned(0));
        assertThrows(Exception.class,()-> meta.isReadOnly(0));
        assertThrows(Exception.class,()-> meta.isWritable(0));
        assertThrows(Exception.class,()-> meta.isDefinitelyWritable(0));
        assertThrows(Exception.class,()-> meta.getColumnClassName(0));
        assertThrows(Exception.class,()-> meta.getPrecision(0));
        assertThrows(Exception.class,()-> meta.getScale(0));
        assertThrows(Exception.class,()-> meta.getColumnDisplaySize(0));
        conn.close();
    }
    ...
    private void testHiddenColumn() throws SQLException {
     ...
     void testProcedureColumns() throws SQLException {
        ...
        assertResultSetMeta(rs, 9, new String[] { "PROCEDURE_CAT",
                ...
                null, null);
        assertResultSetOrdered(rs, new String[][] { { getDbName(),
        ...
        assertResultSetOrdered(rs, new String[][] {
                ...
                { getDbName(), Constants.SCHEMA_MAIN, "PROP", "P1",
                        "" + DatabaseMetaData.procedureColumnIn,
                        "" + Types.VARCHAR, "CHARACTER VARYING", "" + MAX_STRING_LENGTH,
                        "" + MAX_STRING_LENGTH, null, null,
                        "" + DatabaseMetaData.procedureNullableUnknown,
     ...
     void testTypeInfo() throws SQLException {
        ...
        assertResultSetMeta(rs, 18,
                ...
                null, null);
        testTypeInfo(rs, "TINYINT", Types.TINYINT, 8, null, null, null, false, false, false, (short) 0, (short) 0, 2);
        testTypeInfo(rs, "BIGINT", Types.BIGINT, 64, null, null, null, false, false,
                false, (short) 0, (short) 0, 2);
        ...
        testTypeInfo(rs, "NUMERIC", Types.NUMERIC, MAX_NUMERIC_PRECISION, null, null, "PRECISION,SCALE", false, true,
                false, (short) 0, Short.MAX_VALUE, 10);
        testTypeInfo(rs, "DECFLOAT", Types.NUMERIC, MAX_NUMERIC_PRECISION, null, null, "PRECISION", false, false,
                false, (short) 0, (short) 0, 10);
        testTypeInfo(rs, "INTEGER", Types.INTEGER, 32, null, null, null, false, false, false,
                (short) 0, (short) 0, 2);
        testTypeInfo(rs, "SMALLINT", Types.SMALLINT, 16, null, null, null, false, false, false,
                (short) 0, (short) 0, 2);
        testTypeInfo(rs, "REAL", Types.REAL, 24, null, null, null, false, false, false, (short) 0, (short) 0, 2);
        testTypeInfo(rs, "DOUBLE PRECISION", Types.DOUBLE, 53, null, null, null, false, false, false, (short) 0,
                (short) 0, 2);
    ...
    private void testTypeInfo(ResultSet rs, String name, int type, long precision, String prefix, String suffix,
        ...
        assertEquals((short)DatabaseMetaData.typeNullable, rs.getShort(7));
        assertEquals(caseSensitive, rs.getBoolean(8));
        assertEquals((short)DatabaseMetaData.typeSearchable, rs.getShort(9));
    ...
    private void testMore() throws SQLException {
        ...
        assertResultSetMeta(rs, 13, new String[] { "TABLE_CAT", "TABLE_SCHEM",
                ...
                new int[] { Types.VARCHAR, Types.VARCHAR, Types.VARCHAR,
                        ...
                        Types.VARCHAR }, null, null);
        assertResultSetOrdered(rs, new String[][] {
                { getDbName(), Constants.SCHEMA_MAIN, "TEST", "FALSE", getDbName(),
                        "IDX_DATE", "" + DatabaseMetaData.tableIndexOther, "1",
                        "DATE_V", "A", "0", "0" },
                { getDbName(), Constants.SCHEMA_MAIN, "TEST", "FALSE", getDbName(),
                        "PRIMARY_KEY_2", "" + DatabaseMetaData.tableIndexOther,
                        "1", "ID", "A", "0", "0" },
                { getDbName(), Constants.SCHEMA_MAIN, "TEST", "TRUE", getDbName(),
        ...
        assertResultSetMeta(rs, 13, new String[] { "TABLE_CAT", "TABLE_SCHEM",
                ...
                new int[] { Types.VARCHAR, Types.VARCHAR, Types.VARCHAR,
                        ...
                        Types.VARCHAR }, null, null);
        assertResultSetOrdered(rs, new String[][] { { getDbName(),
                Constants.SCHEMA_MAIN, "TEST", "FALSE", getDbName(),
        ...
        assertResultSetOrdered(rs, new String[][] {
                { getDbName(), Constants.SCHEMA_MAIN, "TX2", "BASE TABLE" },
                { getDbName(), Constants.SCHEMA_MAIN, "T_2", "BASE TABLE" } });
        ...
        rs = meta.getTables(null, Constants.SCHEMA_MAIN, "%",
                new String[] { "TABLE" });
        assertResultSetOrdered(rs, new String[][] {
                { getDbName(), Constants.SCHEMA_MAIN, "TEST", "BASE TABLE" },
                { getDbName(), Constants.SCHEMA_MAIN, "TX2", "BASE TABLE" },
                { getDbName(), Constants.SCHEMA_MAIN, "T_2", "BASE TABLE" } });
        stat.execute("DROP TABLE TEST");
        ...
        assertResultSetOrdered(rs, new String[][] {
                { getDbName(), Constants.SCHEMA_MAIN, "TX2", "B",
                        "" + Types.INTEGER, "INTEGER", "32" },
                { getDbName(), Constants.SCHEMA_MAIN, "T_2", "B",
                        "" + Types.INTEGER, "INTEGER", "32" }, });
        trace("getColumns - using wildcards");
        ...
        assertResultSetOrdered(rs, new String[][] {
                { getDbName(), Constants.SCHEMA_MAIN, "T_2", "B",
                        "" + Types.INTEGER, "INTEGER", "32" },
                { getDbName(), Constants.SCHEMA_MAIN, "T_2", "A",
                        "" + Types.VARCHAR, "CHARACTER VARYING", "6" },
                { getDbName(), Constants.SCHEMA_MAIN, "T_2", "C",
                        "" + Types.INTEGER, "INTEGER", "32" }, });
        trace("getIndexInfo");
        ...
        assertResultSetOrdered(rs, new String[][] {
                { getDbName(), Constants.SCHEMA_MAIN, "TX2", "FALSE", getDbName(),
                ...
                { getDbName(), Constants.SCHEMA_MAIN, "TX2", "TRUE", getDbName(),
        ...
        assertResultSetOrdered(rs, new String[][] {
                { getDbName(), Constants.SCHEMA_MAIN, "T_2", "A", "2", "CONSTRAINT_1" },
                { getDbName(), Constants.SCHEMA_MAIN, "T_2", "B", "3", "CONSTRAINT_1" },
                { getDbName(), Constants.SCHEMA_MAIN, "T_2", "C", "1", "CONSTRAINT_1" }, });
    ...
    private void testGeneral() throws SQLException {
        ...
        rs = meta.getCatalogs();
        rs.next();
        assertEquals(getDbName(), rs.getString(1));
        assertFalse(rs.next());
