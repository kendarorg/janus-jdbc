...
public class TestCancel extends TestDb {
    ...
    void testReset() throws SQLException {
        ...
        assertThrows(Exception.class,()->  stat.
    ...
    //FIXME @Test
     void testQueryTimeoutInTransaction() throws SQLException {
        deleteDb("cancel");
        Connection conn = getConnection("cancel");
        Statement stat = conn.createStatement();
    ...
    //FIXME @Test
    void testJdbcQueryTimeout() throws SQLException {
        deleteDb("cancel");
        Connection conn = getConnection("cancel");
        Statement stat = conn.createStatement();
    ...
    //FIXME @Test
    void testMaxQueryTimeout() throws SQLException {
        deleteDb("cancel");
...
//        }
        ...
        for (int i = 1;;) {
            ...
            try {
                Thread.yield();
                assertThrowsStatement(ErrorCode.STATEMENT_WAS_CANCELED, query,
